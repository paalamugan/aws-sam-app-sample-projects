...
```bash
step-functions-demo$ sam logs -n StockCheckerFunction --stack-name step-functions-demo --tail
```
...
```bash
step-functions-demo$ cd functions/stock-checker
...
```bash
sam delete --stack-name step-functions-demo
```
